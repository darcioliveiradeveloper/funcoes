...
function calcularFatorial(n) { // A função 'calcularFatorial' é definida para calcular o fatorial de um número inteiro positivo 'n'
    ...
    let resultado = 1; //  Inicializamos 'resultado' com 1 para começar a multiplicação

    // Criamos um laço que começa em 1 e vai até o número 'n'
    // i++ significa que a cada volta o 'i' aumenta 1 valor (1, 2, 3...)
    for (let i = 1; i <= n; i++) { // O laço vai iterar de 1 até 'n', incluindo 'n'
